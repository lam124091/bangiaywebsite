                                            ...
                                            <c:forEach items="${list}" var="o" varStatus="loop">
                                                <tr>
                                                    ...
                                                    <!--                                                    <td class="align-middle">
                                                                                                            <button class="btnSub" onclick="decreaseQuantity(${o.id})">-</button>
                                                                                                            <strong id="quantity${o.id}">${o.quantity}</strong>
                                                                                                            <a href="ViewCart?id=${o.id}&action=AddCart" >
                                                                                                                <button class="btnAdd" onclick="increaseQuantity(${o.id})">+</button>
                                                                                                            </a>
                                                                                                        </td>-->
                                                    <!--                                                    <td class="align-middle">
...
<!--                                                        <strong id="quantity${o.id}">${o.quantity}</strong>-->
                                                    ...
                                                    <td class="align-middle">
                                                        <!--                                                        <form action="ViewCart" method="post">
                                                                                                                ...
                                                                                                                <!--<a href="ViewCart?id=${o.id}&amp;quantity=0">Remove Item</a>-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="checkoutForm" action="MainController" method="post">
                <!-- Thêm id cho form để tham chiếu trong JavaScript -->
                <div class="modal-header">						
                    <h4 class="modal-title">Checkout</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="action" class="btn btn-success" onclick="showCheckoutSuccess()">Checkout</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    function showCheckoutSuccess() {
        // Hiển thị thông báo "Checkout successful" trong modal
        var successModal = '<div class="modal" id="successModal">' +
            '<div class="modal-dialog">' +
            '<div class="modal-content">' +
            '<div class="modal-header">' +
        ...
        // Chuyển hướng trang sau khi hiển thị modal
        setTimeout(function () {
           
        }, 2000);

        // Ngăn chặn form submit để không chuyển trang ngay lập tức
        return false;
    }
</script>*/
...
//                    success: function () {
//                        // Sau khi xử lý thành công, cập nhật giao diện hoặc làm các bước cần thiết
//                        // ở đây có thể cập nhật số lượng món hàng và giá tiền trong trang Cart.jsp
//                        // ...
//
//                        // Sau đó, có thể làm chuyển hướng hoặc cập nhật giao diện khác
